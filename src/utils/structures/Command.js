...
class Command {
     ...
     * @typedef {{name: String, description: String, adminOnly: Boolean, ownerOnly: Boolean, type: CommandType, slashCommandOptions: ApplicationCommandOption[], run: runFunction}} CommandOptions
